                                ...
                                <div class="card-body">
                                    <div class="media d-flex">
                                        <div class="align-self-center width-100">
                                            <div id="Analytics-donut-chart" class="height-100 donutShadow"><svg
                                                    xmlns:ct="http://gionkunz.github.com/chartist-js/ct" width="100%"
                                                    height="100%" class="ct-chart-donut"
                                                    style="width: 100%; height: 100%;">
                                                    <g class="ct-series ct-series-a">
                                                        <path
                                                            d="M50.416,5A45.424,45.424,0,1,0,50.424,5L50.424,10A40.424,40.424,0,1,1,50.417,10Z"
                                                            class="ct-slice-donut-solid" ct:value="100"></path>
                                                    </g>
                                                    <g><text dx="50.42414474487305" dy="55.1241717338562"
                                                            text-anchor="middle" class="ct-label"
                                                            font-family="feather"></text></g>
                                                    <defs>
                                                        <linearGradient id="donutGradient1" x1="0" y1="1"
                                                            x2="0" y2="0">
                                                            <stop offset="0%" stop-color="rgba(250,203,205,1)"></stop>
                                                            <stop offset="95%" stop-color="rgba(250,203,205, 0.7)"></stop>
                                                        </linearGradient>
                                                    </defs>
                                                </svg></div>
                                        </div>
                                        <div class="media-body text-right mt-1">
                                            ...
                                            <h6 class="mt-1"><span class="text-muted white">Analytics in the <a
                                                        href="#" class="darken-2 white">last year.</a></span></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="heading-elements">
                                    <span class="avatar">
                                        <img src="{{ asset('userdash/theme-assets/images/portrait/small/avatar-s-2.png') }}"
                                            alt="avatar">
                                    </span>
                                    <span class="avatar">
                                        <img src="{{ asset('userdash/theme-assets/images/portrait/small/avatar-s-3.png') }}"
                                            alt="avatar">
                                    </span>
                                    <span class="avatar">
                                        <img src="{{ asset('userdash/theme-assets/images/portrait/small/avatar-s-4.png') }}"
                                            alt="avatar">
                                    </span>
                                </div>
                            </div>
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Jelly beans sugar plum cheesecake cookie oat cake soufflé.Tootsie
                                        roll bonbon liquorice tiramisu pie powder.Donut sweet
                                        roll marzipan pastry cookie cake tootsie roll oat cake cookie.Jelly beans sugar plum
                                        cheesecake cookie oat cake soufflé. Tart lollipop carrot cake sugar plum. </p>
                                    <p class="card-text">Sweet roll marzipan pastry halvah. Cake bear claw sweet. Tootsie
                                        ...
                                        cake.Jelly beans sugar plum cheesecake cookie oat cake soufflé. Tart lollipop carrot
                                        cake sugar plum. Marshmallow
                                ...
                                <div id="carousel-area" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active">
                                            <img src="{{ asset('userdash/theme-assets/images/carousel/08.jpg') }}"
                                                class="d-block w-100" alt="First slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('userdash/theme-assets/images/carousel/03.jpg') }}"
                                                class="d-block w-100" alt="Second slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('userdash/theme-assets/images/carousel/01.jpg') }}"
                                        ...
                                        <div class="media-left pr-1">
                                            <span class="avatar avatar-md avatar-online">
                                                <img class="media-object rounded-circle"
                                                    src="{{ asset('userdash/theme-assets/images/portrait/small/avatar-s-7.png') }}"
                                            ...
                                            <ul class="list-unstyled users-list m-0 float-right">
                                                <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                    ...
                                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                                                        src="{{ asset('userdash/theme-assets/images/portfolio/portfolio-1.jpg') }}"
                                                        alt="Avatar">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                    data-original-title="Product 2" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                                                        src="{{ asset('userdash/theme-assets/images/portfolio/portfolio-2.jpg') }}"
                                                        alt="Avatar">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                    data-original-title="Product 3" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                                                        src="{{ asset('userdash/theme-assets/images/portfolio/portfolio-4.jpg') }}"
                                                        alt="Avatar">
                                                </li>
                                            </ul>
                                    ...
                                    <a href="#" class="media border-0">
                                        <div class="media-left pr-1">
                                            <span class="avatar avatar-md avatar-away">
                                                <img class="media-object rounded-circle"
                                                    src="{{ asset('userdash/theme-assets/images/portrait/small/avatar-s-8.png') }}"
                                                    alt="Generic placeholder image">
                                                <i></i>
                                            </span>
                                        </div>
                                        <div class="media-body w-100">
                                            ...
                                            <ul class="list-unstyled users-list m-0 float-right">
                                                <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                    data-original-title="Product 1" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                                                        src="{{ asset('userdash/theme-assets/images/portfolio/portfolio-5.jpg') }}"
                                                        alt="Avatar">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                    data-original-title="Product 2" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                                                        src="{{ asset('userdash/theme-assets/images/portfolio/portfolio-6.jpg') }}"
                                                        alt="Avatar">
                                                </li>
                                            </ul>
                                            <p class="list-group-item-text mb-0">
                                    ...
                                    <a href="#" class="media border-0">
                                        <div class="media-left pr-1">
                                            <span class="avatar avatar-md avatar-busy">
                                                <img class="media-object rounded-circle"
                                                    src="{{ asset('userdash/theme-assets/images/portrait/small/avatar-s-9.png') }}"
                                                    alt="Generic placeholder image">
                                                <i></i>
                                            </span>
                                        </div>
